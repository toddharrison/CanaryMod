...
public class ContainerHorseInventory extends Container {
    ...
    public ContainerHorseInventory(IInventory iinventory, final IInventory iinventory1, final EntityHorse entityhorse, EntityPlayer entityplayer) {
        this.a = iinventory1;
        this.f = entityhorse;
        byte b0 = 3;
    ...
    public ItemStack b(EntityPlayer entityplayer, int i0) {
        ...
        if (slot != null && slot.e()) {
            ...
            else if (this.a.n_() <= 2 || !this.a(itemstack1, 2, this.a.n_(), false)) {
                return null;
            }
