...
public class Potion {
    ...
    public void a(EntityLivingBase entitylivingbase, int i0) {
        if (this.H == l.H) {
            if (entitylivingbase.aS() < entitylivingbase.aY()) {
                entitylivingbase.f(1.0F);
            }
        }
        else if (this.H == u.H) {
            if (entitylivingbase.aS() > 1.0F) {
            ...
            if (this.H == i.H && !entitylivingbase.aR() || this.H == h.H && entitylivingbase.aR()) {
    ...
    public void a(EntityLivingBase entitylivingbase, EntityLivingBase entitylivingbase1, int i0, double d0) {
        ...
        if ((this.H != h.H || entitylivingbase1.aR()) && (this.H != i.H || !entitylivingbase1.aR())) {
            if (this.H == i.H && !entitylivingbase1.aR() || this.H == h.H && entitylivingbase1.aR()) {
