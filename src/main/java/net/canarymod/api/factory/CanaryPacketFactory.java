    ...
    public Packet createPacket(int id, Object... args) throws Exception {
        ...
        switch (id) {
            ...
            case 0x03:
                ...
                return new CanaryPacket(new S03PacketTimeUpdate((Long) args[0], (Long) args[1], true));
            case 0x04:
                throw new InvalidPacketConstructionException(4, "0x04", "UNKNOWN", "UNKNOWN PACKET");
            case 0x05:
                if (args.length < 3) {
