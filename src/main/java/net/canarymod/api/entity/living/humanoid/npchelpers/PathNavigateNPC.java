 ...
 */
public abstract class PathNavigateNPC {

    protected final EntityNonPlayableCharacter b;
    protected World c;
    protected PathEntity d;
    public double e; // CanaryMod: private => public
    private final IAttributeInstance a;
    private int f;
    private int g;
    private Vec3 h = new Vec3(0.0D, 0.0D, 0.0D);
    private float i = 1.0F;
    private final net.minecraft.pathfinding.PathFinder j;
    ...
    public PathNavigateNPC(EntityNonPlayableCharacter entityNPC, World world) {
        this.b = entityNPC;
        this.c = world;
        this.a = entityNPC.a(SharedMonsterAttributes.b);
        this.j = this.a();
    }

    protected abstract net.minecraft.pathfinding.PathFinder a();
    ...
    public void k() {
        ...
        if (!this.m()) {
            ...
            if (!this.m()) {
                ...
                if (vec3 != null) {
                    this.b.getMoveHelper().a(vec3.a, vec3.b, vec3.c, this.e);
                }
            }
        }
    }
